		...
		>
			<div className="relative w-full max-w-4xl h-full flex items-center justify-center">
				...
				>
                  ...
                  ${
										isExpanded
											? "border-black shadow-lg shadow-gray-400"
											: isRelated
                ...
                `}
                  ...
                  ${isExpanded ? "text-black scale-125" : "text-gray-600"}
                `}
								>
									{item.title}
								</div>
								...
								{isExpanded && (
									<Card className="absolute top-20 left-1/2 -translate-x-1/2 w-64 bg-white/95 backdrop-blur-lg border-gray-300 shadow-xl shadow-gray-300 overflow-visible">
